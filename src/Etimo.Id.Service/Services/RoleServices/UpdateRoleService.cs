...
namespace Etimo.Id.Service
{
    public class UpdateRoleService : IUpdateRoleService
    {
        ...
        public UpdateRoleService(IFindRoleService findRoleService, IRoleRepository roleRepository)
        {
        ...
        {
            Role role = await _findRoleService.FindAsync(updatedRole.RoleId);
        ...
        {
            Role role = await _findRoleService.FindAsync(updatedRole.RoleId, userId);
