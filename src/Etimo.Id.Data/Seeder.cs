        ...
        public static async Task SeedAsync(IEtimoIdDbContext context, IServiceProvider services)
        {
            ...
            context.Applications.Add(
                new Application
                {
                    ...
                    GenerateRefreshTokenForAuthorizationCode   = true,
                    GenerateRefreshTokenForClientCredentials   = false,
                    GenerateRefreshTokenForPasswordCredentials = false,
                    GenerateRefreshTokenForImplicitFlow        = false,
